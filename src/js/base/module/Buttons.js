        ...
        this.ui.dropdown({
          ...
          items: (backColor ? [
            '<div class="note-palette">',
              ...
              '<div>',
                '<button type="button" class="note-color-select" data-event="openPalette" data-value="backColorPicker-' + this.options.id + '">' + this.lang.color.cpSelect + '</button>',
          ...
          (foreColor ? [
            '<div class="note-palette">',
              ...
              '<div>',
                '<button type="button" class="note-color-reset" data-event="removeFormat" data-value="foreColor">' + this.lang.color.resetToDefault + '</button>',
              '</div>',
